...
//         body: JSON.stringify({ channel, contact, message }),
//       });
...
//       alert(result.message || `Notification sent via ${channel}`);
//       setShowPopup(false);
//     } catch (error: any) {
...
//              setShowPopup(true)}}
//           className="bg-green-500 px-5 py-2.5 rounded-lg flex items-center gap-2 text-white font-medium hover:bg-green-600 transition"
//         >
...
//             <h2 className="text-xl font-semibold mb-4">Webinar Preview</h2>
...
//               <div className='flex-grow'>
//                 <label className="block font-medium text-sm">Webinar Title</label>
//                 <input
//                   type="text"
//                   value={title}
...
//                   className="w-full mt-1 px-3 py-2 border border-gray-300 bg-gray-50 rounded-md"
//                 />
//               </div>

//               <div>
//                 <label className="block font-medium text-sm mb-1">Send Via</label>
//                 <select
//                   value={channel}
...
//                   type="text"
//                   placeholder={
//                     channel === 'email' ? 'Enter email' : 'Enter phone number (with country code)'
//                   }
//                   value={contact}
...
//                 type="submit"
//                 disabled={loading}
//                 className="bg-indigo-600 text-white px-5 py-2.5 rounded-lg hover:bg-indigo-700 transition flex items-center gap-2 font-medium"
//               >
