...
//   // Update editor content when content prop changes (e.g., when loading from database)
//   useEffect(() => {
//     if (editorInstance && content !== editorContent) {
//       // Only update if content has changed to avoid circular updates
...
//   // Get the editing toolbar configuration with font styles
...
//             // Get the complete HTML including all formatting
//             const data = editor.getData();
//             setEditorContent(data); // Store current content in state
            
//             // Extract plain text for validation purposes
...
//             // Send both HTML and plain text to parent component
...
//             // Log editor initialization for debugging
