...
//   category?: string;
//   isPublic?: boolean;
//   userId: number; // Still included in response
// }
...
//     return <div className="container mx-auto p-6 text-center">Loading custom template data...</div>;
//   }

//   return (
//     <div className="container mx-auto p-4 max-w-4xl">
//       <div className="flex justify-between">
//         <h1 className="text-2xl font-bold mb-4">{id ? 'Edit Custom Template' : 'Create Custom Template'}</h1>
//         <div>
//           <button
//             onClick={() => navigate('/custom-view')}
//             className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-800 transition-colors flex items-center gap-2"
//             type="button"
//           >
...
//         <div className="mb-6">
//           <label className="block text-gray-700 mb-2" htmlFor="template-select">
//             Choose a Template
//           </label>
...
//               className="w-full p-3 border rounded-lg appearance-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
...
//             </div>
//           </div>
//           {loadingTemplates && <p className="mt-2 text-sm text-gray-500">Loading templates...</p>}
//         </div>
...
//             Use placeholders: {name}, {email}, {phone}, {webinar_title}, {webinar_date}, {webinar_time}. Type {'{'} to see suggestions.
//           </p> */}
//           <RichTextEditor
//             content={customTemplate.content || ''}
//             onChange={handleContentChange}
